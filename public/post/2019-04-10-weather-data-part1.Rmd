...
categories: ['R', 'weather data', '`rnoaa`']
comment: true
...
*n.b.*: For how to store an API key, I referred to Section 2.4 ['R Startup'](https://csgillespie.github.io/efficientR/r-startup.html#r-startup-arguments) in @efficient.
...
![](/post/2019-04-10-weather-data-part1_files/rainfall2006-11-01.png)

<hr>

That completes the first task of collecting the data. :smile: Next in [Part II](`r blogdown::shortcode('ref', '/post/2019-04-18-weather-data-part2')`), we'll be performing interpolation on these shapefiles to get precipitation level for each county. 