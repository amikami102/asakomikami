...
# Who reaps the benefit of global science? 

![Columns 1 - 4 of Table 4 from Fry (2019)](/post/2020-05-15-fry_files/CFry-tab4.png)

Column 4 of Table 4 shows that the scientists in the treatment group are not listed as first authors more frequently than the control group at a statistically significant level even though they are publishing more and in prestigious journals. Fry notes that this "raises the questions on the role of the African scientists on projects, and the possibility that they are 'long-arm' of the American labs (20)" in which "African scientists carry out low-skilled filed work tasks to deliver samples to the United States for analysis" (27). While I give props to Fry for taking note on this questionable aspect of 'global science,' I am disappointed that this is not investigated further and that there are no quotes from her interviews with the trainees and African scientists to show their thoughts on this matter. I don't know the extent to which the life science community is [conscious](https://www.thelancet.com/journals/langlo/article/PIIS2214-109X(18)30239-0/fulltext) of the predatory behavior of parachute researchers who capitalize on cheap labor and publish in prestigious journals using the samples collected in the developing world without giving credit to local scientists. But then again, maybe I'm being unfair given that [political scientists](https://doi.org/10.1017/S1049096518000379) who conduct field work in developing countries aren't necessarily behaving better. 


# Conclusion

This paper pays a lot of attention to the causal mechanism and integrates the sociological theory in the background into the analysis of the sample at hand. Unlike most empirical papers that are interested in identifying the treatment effect on the main outcome and only inquire into the causal mechanism as a filler before the conclusion section, the causal mechanism is the essence of Fry's paper. Using what she learned from her interviews, Fry tests additional hypotheses on the heterogeneity in treatement effect. After Table 4, which reports the estimates of the regression coefficient $\hat{\beta}_2$ on publication outcomes, the subsequent tables inspect the causal mechanism and the heterogeneity in treatement effect. For example in Table 8, Fry looks at whether trainees who took up administrative positions in their home countries are more likely to have an impact than those who assumed technical or teaching positions. I think the mixed method approach adds thickness to Fry's research that is lacking in most empirical papers in Economics. 

But more than that, there is a specific reason I chose to review this paper. I wrote in the subtitle of this blog post, "Studying networks with good ol' regressions," because I'm adding Fry's paper to my collection of empirical works whose research question pertains to network effects but whose research design employ familiar tools like regressions. A case in point is [Jaffe, Trajtenberg, and Henderson (1993) "Geographic Localization of Knowledge Spillovers as Evidenced by Patent Citations"](https://doi.org/10.2307/2118401), whose design of publication-to-publication citation rate Fry uses in her paper. The other one in the collection is [Azoulay, Zivin, and Wang (2016) "Superstar Extinction"](https://doi.org/10.1162/qjec.2010.125.2.549), which is my favorite paper that studies a very similar phenomenon to Fry's. I think reading these papers and Fry's would be valuable for other researchers studying the effect of social networks. 
