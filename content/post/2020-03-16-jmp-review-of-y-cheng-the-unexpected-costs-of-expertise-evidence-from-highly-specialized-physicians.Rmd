...
For my first post of this series, I am reviewing Yi Cheng's job market paper, ["The Unexpected Costs of Expertise: Evidence from Highly Specialized Physicians"](https://asit-prod-web1.cc.columbia.edu/econdept/wp-content/uploads/sites/41/2019/09/YiCheng_JMP_current.pdf)(November 4, 2019). The abstract begins,
...
The research question is, "What is the effect of matching highly-skilled physician to a low-risk patient?"

- *Treatment*: physician-patient (mis)match
...
![Figure B6 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-figB6.png)
...
![Figure B3 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-figB3.png)
...
![Figure 2 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-fig02.png)
...
![Figure 3 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-fig03.png){width=100%}
...
![FIgure 4 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-fig04.png)


Figure 5 extends the result by conditioning on congestion level on day -1. This one is a little tricky to interpret, so I will paste Cheng's own words:

![Figure 5 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-fig05.png)
...
*This part stumped me at first because it looks like low congestion (right panel) has higher peak on day 0 than high congestion (left panel), which is opposite of the description.*:confused: I wondered if the panels were supposed to be switched, but what I think Cheng means is that when NICU capacity is tight (left panel), mid-risk newborns who were admitted prior to day 0 are likely to be treated by specialized physicians. This makes sense because all hands are on deck and patient-to-physician ratio would tend to be high. On the other hand, when there is some slack in NICU occupancy, it sounds reasonable to me that specialized physicians wouldn't have their hands full with mid-risk newborns. I think what Cheng is saying is that the pre-treatment trends for the rest of the paper, not the post-treatment trend. The post-treatment trends, which are different in high and low congestion levels, matter when it comes to deciding a cutoff point for treatment/control group. For now, the takeaway is that incumbent patients are more likely to be treated by specialized physicians when NICU is already congested prior to the unscheduled admission of high-risk patient.
...
1. Since newborns are rarely discharged on the same day of their hospital admission, being admitted on day -2 or -1 leaves substantial chance of encountering a high risk newborn during their stay in NICU. Since they are admitted prior to day 0,  
2. Midrisk newborns admitted on days $\pm$ 3, $\pm$ 4, and $\pm$ 5 are less likely to compete with the high risk patient admitted on day 0 for NICU resources as the high-risk patient takes up 50% to 20% of NICU procedures on days 0 through 2. Therefore, being admitted on day 3 (-3) or later (earlier) constitutes a comparable *control* treatment ...
3. ... for the same reason that being admitted between day 0 and 2 are vulnerable to resource competition with the high risk patient. Hospitals may choose to admit healthier babies who would consume less NICU resources, and therefore there is a potential selection bias. 
...
![Equation 2 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-eq2.png)


![Equation 3 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-eq3.png)
...
![Table 5 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-table5.png)
...
![Table 6 Panel 1 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-table6-1.png)

![Table 6 Panel 2 from Cheng (2019)](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-table6-2.png)
...
If I have any disappointment, it is in her explanation of the potential causal mechanism. She gives some explanations for what might be going on that lead to these empirical results. She surmises that specialized physicians are inadept at tuning their diagnosis on mid-risk patients in the event of unexpected admission of high-risk newborn because they rely on heuristics to make short-cut judgements. Unfortunately, the sample size was too small to test this hypothesis (38). Yet even if the sample size was bigger, I don't think there would be much insight to be gained. I would like to hear what physicians think of the results shown in this paper. Would they be surprised? What goes through their head when they are treating a low-risk patient rather than a high-risk patient? I think this is where a qualitative research like interviewing the doctors, the hospital administrators, and the nurses would be more useful and add thickness to this study. Some might say that interviewing doctors in this context would be pointless because they would claim that they are giving the proper level of care and treatment to every patient and that Cheng is not employing the right outcome variables. I would say that the fact that they would make such a claim would be interesting in and of itself, either as an evidence of self-conceit or a constructive criticism of the research design.
