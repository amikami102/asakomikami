...
*This blog post is part of my "JMP by women in econ" series where I summarize and review some of the job market papers written by women PhD candidates. The papers are selected from Jennifer Doleac's [Twitter thread](https://twitter.com/jenniferdoleac/status/1187863251947806720). I am not reading this from the perspective of an economist, let alone of a job committee member: I just like reading observational studies that tackle challenging research problems.:bowtie:* 

I am reviewing Yi Cheng's job market paper, ["The Unexpected Costs of Expertise: Evidence from Highly Specialized Physicians."](https://asit-prod-web1.cc.columbia.edu/econdept/wp-content/uploads/sites/41/2019/09/YiCheng_JMP_current.pdf) Here is an excerpt from the abstract:
...
The research question is, "What is the effect of matching intensive care treatment administered by highly-skilled physician to a low-risk patient?", i.e.

- the treatment is physician-patient (mis)match, and
- the outcome is the patient's health as measured by days to discharge, remission rate, and hospital charge. 
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-figB6.png)
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-figB3.png)
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-fig02.png)
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-fig03.png){width=100%}
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-fig04.png)
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-fig05.png)
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-eq2.png)


![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-eq3.png)
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-table3.png)

![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-table4.png)
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-table5.png)
...
![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-table6-1.png)

![](/post/2020-03-16-jmp-review-of-y-cheng-the-unexpected-costs-of-expertise-evidence-from-highly-specialized-physicians_files/YiCheng-table6-2.png)
...
I too disagree with the cynical reader; I think the paper is worth it for showing the counterintuitive result that a specialist does not outperform a non-specialist in tasks where they are overqualified. If I have any disappointment, it is in her explanation of the potential causal mechanism, and this isn't even her fault. Cheng finds that the treatment group was more likely to receive the same procedure done on unscheduled high-risk newborn than the control group (Figure A12). She surmises that specialized physicians are inadept at tuning their diagnosis on mid-risk patients in the event of unexpected admission of high-risk newborn because they rely on heuristics to make short-cut judgements. Unfortunately, the sample size was too small to test this hypothesis (38). 
